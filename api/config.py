...
_SETTINGS_DEFAULTS = {
    ...
    "check_for_updates": False,  # HumR-managed deployments do not offer upstream updates
    ...
    "hidden_tabs": [  # HUMR: sidebar tabs hidden by default; chat and settings are always visible
        "kanban",
        "workspaces",
        "profiles",
        "todos",
